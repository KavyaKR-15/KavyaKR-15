...
[![Portfolio](https://img.shields.io/badge/Portfolio-kavyakr--portfolio-FF5733?style=flat-square&logo=netlify&logoColor=white)](https://kavyakr-portfolio.netlify.app/)
[![Email](https://img.shields.io/badge/Email-radhakavya68%40gmail.com-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:radhakavya68@gmail.com)
...
class KavyaKR:
    def __init__(self):
        ...
        self.portfolio   = "kavyakr-portfolio.netlify.app"

        self.stack = [
            "Python", "Java", "C",
            "HTML", "CSS", "JavaScript",
            "React.js", "Node.js", "Express.js",
            "MongoDB", "SQLite", "OpenCV",
            "Tkinter", "Groq AI"
        ]
...
![Groq](https://img.shields.io/badge/Groq_AI-F55036?style=flat-square&logo=ai&logoColor=white)
...
<details>
<summary><b>🏢 Appin Technology — Web Development Intern | 2024 | Coimbatore</b></summary>

> `HTML` `CSS` `JavaScript` `Web Development`

- 🌐 Completed an intensive **15-day hands-on internship** focused on full-stack web development fundamentals.
- 💡 Built and deployed responsive web pages applying real-world UI/UX best practices.
- 🔧 Gained practical exposure to industry-standard web development workflows and version control.
- 📚 Strengthened foundation in front-end technologies through project-based learning.
...
| 🏭 | **SmartOps360 Presentation** | MSME sector event at Dr. N.G.P. Institute of Technology |
| 🎨 | **Workshop — Front-End Development** | Rathinam Institute of Technology |
